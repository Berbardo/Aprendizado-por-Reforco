...
class Critic(nn.Module):
    def __init__(self, env):
        ...
        self.bn1 = nn.BatchNorm1d(400)
        self.linear2 = nn.Linear(400 + env.action_space.shape[0], 300)
        self.bn2 = nn.BatchNorm1d(300)
...
class TD3:
    def __init__(self, env, alpha=0.001, beta=0.001, gamma=0.99, tau=0.005, policy_noise=0.2, noise_clip=0.5, policy_freq=2):
    ...
    def _train_critics(self, states, actions, rewards, next_states, dones):
        noise = actions.data.normal_(0, self.policy_noise).to(device)
